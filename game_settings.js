...
3. **【重要】窮鬼模式**：如果你的背包是空的（或覺得東西不夠用），請展現出對物質的極度渴望！
   - 請嘗試「四處搜索」、「翻找垃圾桶」、「向路人乞討」或「碰瓷」。
   - 你的目標是獲取任何可以用的東西，哪怕是一張衛生紙。
4. 請回傳 JSON 格式。

【JSON 格式範例】
{
  "thought": "我兩手空空，心裡發慌。前面有個看起來很有錢的主管走過，或許地上會掉什麼東西？",
  "target_item_ids": [], 
  "action_type": "search", // use_item, search, meditate, explore
  "intention_description": "仔細搜索辦公室地板，試圖尋找前輩遺留的法寶（或零錢）"
}
`,
        // AI 2: 天道 (決定發生什麼事)
        PROMPT_DM: `
...
【JSON 格式範例】
{
  "story": "你在茶水間翻箱倒櫃，雖然沒找到法寶，但發現了一包過期的茶包和一隻還有電的雷射筆。",
  "result_type": "success",
  "effect_summary": "獲得過期茶包、雷射筆",
  "new_items": [
      { "name": "過期茶包", "icon": "🍵", "tags": ["毒藥", "提神"], "description": "雖然過期了，但散發著一股令人清醒的黴味。" },
      { "name": "雷射筆", "icon": "🔦", "tags": ["武器", "光屬性"], "description": "開會用的神器，似乎能射瞎狗眼。" }
  ],
